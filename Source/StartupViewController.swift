...
class StartupViewController: UIViewController, InterfaceOrientationOverriding {
    ...
    private func setupDiscoverButtons() {
        ...
        discoverButton.snp_makeConstraints { (make) in
            ...
            let _ =  environment.config.courseEnrollmentConfig.isEnabled || environment.config.programEnrollmentConfig.isEnabled ? make.height.equalTo(40) : make.height.equalTo(0)
        }
